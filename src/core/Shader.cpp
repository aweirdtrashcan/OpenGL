...
Shader::Shader(const std::string& vertexPath, const std::string& fragmentPath) {
    std::string stdbuf = readShaderFile(vertexPath.c_str());
    ...
    stdbuf = readShaderFile(fragmentPath.c_str());
    code = stdbuf.c_str();
...
void Shader::setMatrix(const char *uniformName, const float *matrix_ptr) {
